          ...
          <div className='flex text-xs ' >
                <div className=' w-1/2 ' >
                    <div className='flex mb-5 ' >
                        ...
                        <input type="text" name="" className='bg-white border border-black w-1/2 rounded-md px-1' id="" />
                    </div>
                    <div className='flex mb-5' >
                        <p className='w-2/5 pt-1 mr-2' >LTV</p>
                        <input type="text" name="" className='bg-white border border-black w-1/5 py-1 rounded-md px-1' id="" />
                    </div>
                    <div className='flex mb-5' >
                        <p className='w-2/5 pt-1 mr-2' >Maksimum Nilai Pinjaman</p>
                        <input type="text" name="" className='bg-white border border-black w-1/2 py-1 rounded-md px-1' id="" />
                    </div>
                    <div className='flex mb-5' >
                ...
                <div className=' w-1/2 '>
                    ...
                    <div className='flex mb-5' >
                        ...
                        <div className='flex w-3/5 ' >
                            ...
                            <span className='w-1/2'>
                                Per
                            <input type="text" name="" className='bg-white border border-black w-2/5 py-1 rounded-md px-1 ' id="" /> Bulan
                            </span>
                        </div>
                    </div>
                    <div className='flex mb-5' >
