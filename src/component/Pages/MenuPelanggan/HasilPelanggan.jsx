...
export default function HasilPelanggan() {
  ...
  return (
    <div className="overflow-x-auto rounded shadow bg-white">
            ...
            <div className="px-10">
                <table className="my-5 table-auto w-full border-collapse border border-black">
                    <thead>
                        <tr className="bg-gray-300">
                            <th className="text-center py-1 text-sm border border-black">ID Customer</th>
                            ...
                            <th className="text-center py-1 text-sm border border-black">Jenis Usaha</th>
                            <th className="text-center py-1 text-sm border border-black">Nomor HP</th>
                ...
                {openForm ? (<DetailPelanggan onClick={() => setOpenForm(false)} />) : null}
