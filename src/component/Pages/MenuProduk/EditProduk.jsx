...
const EditProduk = () => {
  return (
    <div>
      <input type="checkbox" id="prod-ubah" className="modal-toggle " />
      <div className="modal modal-bottom sm:modal-middle ">
        <div className="modal-box ">
          <h3 className="font-bold text-lg">Pengaturan Produk - Ubah</h3>
          ...
          <div className="modal-action">
            <label htmlFor="prod-ubah" className="btn btn-md rounded-md">
              Kembali
            </label>
            <label htmlFor="prod-ubah" className="btn btn-md rounded-md">
              Simpan
